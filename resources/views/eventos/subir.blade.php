...
@section('contenido')
	...
	<div class="col-md-10 col-md-offset-1">
		<h3 class="page-header"><span class="fa fa-upload "></span> Subir puntos para la actividad: <small>{{  $evento[0]->actividad }}</small></h3>
	</div>
		  	...
		  	<div class="panel-body"><br>
				...
				<div class="col-md-7">
		  			<form class="form-responsive">
						...
						<textarea placeholder="Introduce los numeros de cuenta..." class="form-control" rows="5"></textarea><br>
